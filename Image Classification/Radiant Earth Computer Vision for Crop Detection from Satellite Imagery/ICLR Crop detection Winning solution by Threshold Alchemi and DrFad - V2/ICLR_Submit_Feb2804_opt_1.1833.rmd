...
##########################################################################
for (i in seq(1,13,1)){
 ICLR_train[,paste0("exblue","_",dt[i])] <- 2*ICLR_train[,paste0("B03","_2019",dt[i])] - ICLR_train[,paste0("B04","_2019",dt[i])] - ICLR_train[,paste0("B02","_2019",dt[i])]
}

#Exgreen test
for (i in seq(1,13,1)){
 ICLR_test[,paste0("exblue","_",dt[i])] <- 2*ICLR_test[,paste0("B03","_2019",dt[i])] - ICLR_test[,paste0("B04","_2019",dt[i])] - ICLR_test[,paste0("B02","_2019",dt[i])]
}
dim(ICLR_train)
...
# # ICLR_train<-  SmoteClassif(label ~ ., ICLR_train, list(`1` = 1, `2` = 1,`3` = 1, `4` = 3, `5`= 8.5,`6` = 9.14,`7`=1))
# 
# table(ICLR_train$label)
```
#Parameter Tuning
...
write.csv(ICLR_Submit, file = "C:/Users/A199702/Documents/Zindi/Crop Recognition/ICLR_Submit_Feb2804_opt_1.1833.csv", row.names = F)
beep(6)
