...
from CGIAR.slim.deployment import model_deploy
from CGIAR.slim.nets import nets_factory
from CGIAR.slim.preprocessing import preprocessing_factory
from CGIAR.slim.utils import learning_rate_schedule


from CGIAR.slim.my_slim import learning as my_learning
...
tf.app.flags.DEFINE_float(
    'learning_rate_decay_factor', 0.925, 'Learning rate decay factor.')
